...
from networksecurity.constant.training_pipeline import DATA_TRANSFORMATION_IMPUTER_PROGRAMS
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        ...
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PROGRAMS)
            logging.info(
                f"Initialise KNNImputer with {DATA_TRANSFORMATION_IMPUTER_PROGRAMS}"
            )
